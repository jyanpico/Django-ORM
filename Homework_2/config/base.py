"""
Django settings for Homework_2 project. Includes some improvements
from the default startproject template. Learn more at:
...
SECRET_KEY = 'django-insecure-$)4g@h_t7+0)3vwkf6^)#gbk^8(j$36^yw^wzz5iifw&!+re9f'
